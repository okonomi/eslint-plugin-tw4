...
export type ParsedClassInfo = {
  original: string
  parsed: ParsedClass
  baseParsed: ParsedBaseClass | null
}

export function parseClasses(classes: string[]): ParsedClassInfo[] {
...
function parseBaseClass(baseClass: string): ParsedBaseClass | null {
